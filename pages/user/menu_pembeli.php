  ...
  <!-- Menu -->
      <div class="container">
        <div class="row mt-3">
          ...
          $query = mysqli_query($koneksi, 'SELECT * FROM produk WHERE stok > 0');
            ...
            <div class="card brder-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label><br>
                <a href="../control/user/beli.php?id_menu=<?php echo $result['id_menu']; ?>" class="btn btn-success btn-sm btn-block ">BELI</a>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
