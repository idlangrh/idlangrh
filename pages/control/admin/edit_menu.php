...
<html lang="en">
  <head>
    ...
    <title>Form Edit Katalog</title>
  </head>
  <body>
 
 <!-- Form Registrasi -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">SILAHKAN EDIT KATALOG</h3>
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jenis_menu" value="Makanan">Baju
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
