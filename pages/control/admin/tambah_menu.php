...
<html lang="en">
  <head>
    ...
    <title>Form Tambah Katalog</title>
  </head>
  <body>
 ...
 <!-- Form Registrasi -->
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="form-group">
          <label for="menu1">Nama Pakaian</label>
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="Makanan" name="jenis_menu" checked>Baju
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="Minuman" name="jenis_menu">Celana
            </label>
          </div>
         </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="harga1">Harga Pakaian</label>
  ...
  if(isset($_POST['tambah'])){
    ...
    if($insert){
      header("location: ../../admin/daftar_menu.php");
    }
    else {
