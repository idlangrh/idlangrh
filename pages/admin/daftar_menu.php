...
<html lang="en">
  ...
  <!-- Menu -->
      <div class="container">
        <a href="../control/admin/tambah_menu.php" class="btn btn-success mt-3">TAMBAH DAFTAR KATALOG</a>
        <div class="row">
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              <img src="../../upload/<?php echo $result['gambar'] ?>" class="card-img-top" style="width: 200px; height: 200px;" alt="...">
              <div class="card-body">
               ...
               <label class="card-text stok"><strong>Stok: </strong> <?php echo number_format($result['stok']); ?></label><br>
                <a href="../control/admin/edit_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-success btn-sm btn-block">EDIT</a>

                <a href="../control/admin/hapus_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-danger btn-sm btn-block text-light">HAPUS</a>
              </div>
            </div>
          </div>
              <?php endforeach; ?>
